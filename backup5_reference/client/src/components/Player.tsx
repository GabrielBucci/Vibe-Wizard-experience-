...
export const Player: React.FC<PlayerProps> = ({
  ...
  const determineLocalAnimation = useCallback((input: any, isGrounded: boolean): string => {
    ...
    // If in air, play jump animation (unless attacking/casting/dead which we don't track fully here yet)
    if (!isGrounded) return ANIMATIONS.JUMP;
  ...
  useEffect(() => {
    // Explicitly wrap hook body
    {
      ...
      const isMovementAnim = serverAnim.startsWith('walk') || serverAnim.startsWith('run') || serverAnim === 'idle';
